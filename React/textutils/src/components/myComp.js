    ...
    return (
        <div className="container my-5" style={props.pageTheme()}>
           <div className="mb-3">
            ...
            <textarea className="form-control" id="exampleFormControlTextarea1" rows="8" placeholder="Enter text here..." value={text} style={props.pageTheme()} onChange={onChangeFunc}></textarea>
            <button className="btn btn-primary mx-1 my-3" onClick={uppercase}>UpperCase</button>
            <button className="btn btn-primary mx-1" onClick={lowercase}>LowerCase</button>
            <button className="btn btn-primary mx-1" onClick={inversecase}>InverseCase</button>
            <button className="btn btn-primary mx-1" onClick={findNreplace}>Find and Replace</button>
          ...
          <div className="container">
            {(text.split(" ").includes(''))?(text.split(" ").length-1):text.split(" ").length} Words and {text.length} Characters <br/>
